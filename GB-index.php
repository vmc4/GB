			...
			<div class="Column-two">
				<div class="Content-border">
					<div class="Content">
						...
						<div style="float: left; width:60%; height:70%; background-color:black;">
							<p style="text-align:center;">Featured Games</p>
							<div name="featureTitle" style="text-align:center; font-size:16pt;
							margin-top: 5px;">
								Feature Pic Game name
							</div>
							<div name="featurePic" style="height:300px; width:230px; 
							border:1px lightgrey groove; margin-left:auto;
							margin-right:auto; margin-top:5px;">
								<img src="mw3.jpeg" height="250px" width="200px">
							</div>
							<p style="text-align:center; margin-top:5px;">
								Time Remaining: <?php echo ?>
							</p>
							<input type="button" name="featureBid" style="width:50%;
							 margin-left:25%;" onclick="location.href='GB-listing.php'"
							 value="Make a Bid"/>
						</div>	
							</div>
						</div>	
