				...
				<div class="Content-border">
					<div class="Content">
						<div class="Content">
    							...
    							$gameName=$_GET['offerName'];
								$systemName=$_GET['offerSystem'];
								$gameGenre=$_GET['offerGenre'];
								$lister=$_GET['lister'];
								$offeror=$_GET[''];
								$dollarOffer=$_GET['dollarOffer'];
							...
							$insert = mysqli_query($con, "INSERT INTO Offers(Date_Added, Offer_No, Listing_No, Lister, Offeror, Game_Name, System,
									 						Genre, Cov_Img, Cond_Img, Dollar_Offer)
							VALUES ($timeAdded, DEFAULT, '$listingNo', '$lister', 123, '$gameName', '$systemName', '$gameGenre', '$discImage', '$discCondition', '$dollarOffer')");
									
								if ($insert)
									{
									echo "Your Offer has been submitted. <br>
